...
namespace CategoryService.Test
{
    public class CategoryControllerTest
    {
        ...
        {
            int categoryId = 101;
            Category category = new Category { Id = 101, Name = "Sports", CreatedBy = "Mukesh", IsPublic=true, CreationDate = new DateTime() };
        ...
        {
            List<Category> category = new List<Category> { new Category { Id = 101, Name = "Sports", CreatedBy = "Mukesh", IsPublic=true, CreationDate = new DateTime() } };
